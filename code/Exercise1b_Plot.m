...
a_5_1 = annotation(fig1,'textbox',...
    [0.683537025112685 0.02 0.014 0.0195],...
    'FontWeight','bold',...
    'String',{'f_{c}-f_{m}'},...
    'HorizontalAlignment','center',...
    'FitBoxToText','off',...
...
set(ax5,...
    ...
    'XLim',[floor((f_c-f_m)-(f_c-f_m)*0.05) floor((f_c+f_m)*1.05)],...
    'XTick',f_output(4:end));
